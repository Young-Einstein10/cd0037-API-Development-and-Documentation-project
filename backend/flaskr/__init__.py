...
def get_hash_categories(categories):
    hashed_categories = {}
    for category in categories:
        hashed_categories[category.id] = category.type
...
def create_app(test_config=None):
    ...
    def fetch_categories():
        ...
        hashed_categories = get_hash_categories(categories)
    ...
    def get_questions_by_category(category_id):
        ...
        selection = category.get_questions()
